...
INTEGRACAO = Path(__file__).resolve().parent.parent
...
st.caption("Leitura real pela câmera. A previsão usa os modelos do rio sobre um "
           "cenário simulado de chuva, e a variação prevista é somada à régua.")
